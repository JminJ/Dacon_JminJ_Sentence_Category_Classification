...
class SentenceCategoryClassifier(nn.Module):
    def __init__(self, base_ckpt:str, drop_rate:float):
        ...
        self.category_layer = nn.Linear(768, 4)
        self.sentiment_layer = nn.Linear(768, 3)
        self.tense_layer = nn.Linear(768, 3)
        self.certainty_layer = nn.Linear(768, 2)
...
if __name__ == "__main__":
    sentence_classifier = SentenceCategoryClassifier(base_ckpt="monologg/koelectra-base-v3-discriminator")